...
# 100 Master Topics Exhaustive Metadata Dictionary
TOPICS_METADATA = [
    ...
    },
    {
        ...
        "treatise": "《伏羲先天八卦图》",
        "essence": "បង្ហាញពីសណ្តាប់ធ្នាប់ និងតុល្យភាពលោហធាតុដំបូង៖ Qian នៅត្បូងទល់នឹង Kun នៅជើង, Li នៅកើតទល់នឹង Kan នៅលិច។",
        "formula": "天地定位，山泽通气，雷风相薄，水火不相射。八卦相错，数往者顺，知来者逆。",
        "remedy": "ប្រើប្រាស់កញ្ចក់ប៉ាហ្គ័រមេឃដើមសម្រាប់ការពារ និងបង្វែរព្រួញពិឃាត Sha Qi ពីខាងក្រៅគេហដ្ឋាន។",
        "geo": "ដីធ្លីដែលមានតុល្យភាពមេឃដើម នាំមកនូវសេចក្តីសុខសាន្តយូរអង្វែងដល់មនុស្សជំនាន់ក្រោយ។",
        "qi": "ថាមពល Yin និង Yang ស្ថិតក្នុងសភាពស្មើគ្នានិងបំពេញឱ្យគ្នាទៅវិញទៅមក។",
        "time": "ជាគ្រឹះនៃក្បួន Xuan Kong Da Gua សម្រាប់គណនាភាពស៊ីសង្វាក់គ្នាក្នុងយុគ ៩។",
        "bazi": "ជួយការពារជោគជតាម្ចាស់ផ្ទះពីគ្រោះមហន្តរាយធំៗ។",
        "taboo": "ហាមព្យួរប៉ាហ្គ័រមេឃដើមនៅខាងក្នុងផ្ទះ (ត្រូវព្យួរតែនៅក្រៅផ្ទះបែរចេញក្រៅប៉ុណ្ណោះ)។"
    },
    {
        ...
        "geo": "កំណត់ទិសដៅផ្ទះតាមទិសទាំង ៨ ពិតប្រាកដលើផ្ទៃផែនដី។",
        "qi": "លំហូរថាមពលតាមរដូវកាលទាំង ៤ (និទាឃរដូវ គិម្ហរដូវ សរទរដូវ រំហើយ)។",
        "time": "យុគទី ៩ ផ្តោតលើទិស Li Palace (ខាងត្បូង) នៃប៉ាហ្គ័រមេឃក្រោយ។",
        "bazi": "តម្រឹមទិសផ្ទះឱ្យត្រូវនឹងទិសកំណើត Life Gua របស់ម្ចាស់ផ្ទះ។",
        "taboo": "ហាមច្រឡំរវាងទីតាំងទិសមេឃដើម និងមេឃក្រោយក្នុងការវាស់ឡូប៉ាន។"
    },
    {
        ...
        "formula": "乾为天、为圆、为君、为父、为玉、为金、为冰、为大赤、为良马。",
        "remedy": "ទិសពាយព្យមិនត្រូវធ្វើជាផ្ទះបាយដាច់ខាត (Fire burning Heaven's Gate) បណ្តាលឱ្យមេគ្រួសារធ្លាក់ចុះសុខភាព និងអំណាច។",
        "geo": "ទិសពាយព្យត្រូវមានអគាររឹងមាំ និងគ្មានគំនរសម្រាម ឬលូទឹកស្អុយ។",
        "qi": "ថាមពល Yang Metal ផ្តល់នូវអំណាច សេចក្តីថ្លៃថ្នូរ និងការគោរពកោតខ្លាច។",
        "time": "យុគទី ៩ ត្រូវបន្ថែមធាតុដី (Earth) នៅទិសពាយព្យដើម្បីបង្កើតធាតុលោហៈ (Earth produces Metal)។",
        "bazi": "ជួយពង្រឹងកម្លាំងដល់អ្នកដែលមាន Day Master ជា Geng Metal ឬ Xin Metal។",
        "taboo": "ហាមដាក់ចង្ក្រានហ្គាស ឬដុតភ្លើងទៀងទាត់នៅទិសពាយព្យ (NW)។"
    },
    {
        ...
        "formula": "坤为地、为母、为布、为釜、为吝啬、为均、为子母牛、为大舆。",
        "remedy": "ទិសនិរតីត្រូវរក្សាភាពស្អាតបាត មិនត្រូវមានគំនរសម្រាម ឬបន្ទប់ទឹក ដែលធ្វើឱ្យប៉ះពាល់ដល់សុខភាពស្ត្រីមេផ្ទះ។",
        "geo": "ដីទិសនិរតីត្រូវមានភាពរាបស្មើ និងមានស្ថិរភាពរឹងមាំ។",
        "qi": "ថាមពល Yin Earth ផ្តល់នូវភាពកក់ក្តៅ និងសាមគ្គីភាពក្នុងគ្រួសារ។",
        "time": "ក្នុងយុគទី ៩ ធាតុភ្លើង Li Fire បង្កើតធាតុដី Kun Earth នាំឱ្យស្ត្រីមានអំណាច និងលាភធំ។",
        "bazi": "ជួយទ្រទ្រង់ Day Master ធាតុ Wu Earth និង Ji Earth។",
        "taboo": "ហាមកាប់ដើមឈើធំៗ ឬជីកស្រះជ្រៅនៅទិសនិរតី (SW) នាំឱ្យខូចខាតសុខភាពម្តាយ។"
    },
    {
        ...
        "formula": "震为雷、为龙、为玄黄、为旉、为大涂、为长男、为决躁、为苍筤竹。",
        "remedy": "ដាក់ដើមរុក្ខជាតិបៃតង ឬទឹកហូរនៅទិសខាងកើត ដើម្បីជំរុញភាពសកម្ម និងការចាប់ផ្តើមអាជីវកម្មថ្មី។",
        "geo": "ទិសខាងកើតត្រូវមានរុក្ខជាតិបៃតងស្រស់បំព្រង និងពន្លឺថ្ងៃព្រឹកព្រលឹម។",
        "qi": "ថាមពល Yang Wood នាំមកនូវភាពរស់រវើក ការច្នៃប្រឌិត និងភាពស្វាហាប់។",
        "time": "យុគទី ៩ ធាតុឈើ Zhen ជួយដុតបញ្ឆេះធាតុភ្លើង Li Fire ឱ្យកាន់តែរុងរឿង។",
        "bazi": "ផ្តល់កម្លាំងដល់ Day Master ធាតុ Jia Wood។",
        "taboo": "ហាមដាក់វត្ថុធាតុលោហៈធ្ងន់ៗ ឬកាត់ដើមឈើទាំងអស់នៅទិសខាងកើត (Metal destroys Wood)។"
    },
    {
        ...
        "formula": "巽为木、为风、为长女、为绳直、为工、为白、为长、为高、为进退。",
        "remedy": "ទិសអាគ្នេយ៍ជាទិសកំណប់ទ្រព្យ (Wealth Palace) ត្រូវដាក់រុក្ខជាតិស្លឹកមូល ឬអាងចិញ្ចឹមត្រីដើម្បីទាក់ទាញលាភ។",
        "geo": "ដីទិសអាគ្នេយ៍ត្រូវមានខ្យល់បក់ស្រាលៗ និងមានរុក្ខជាតិលម្អស្អាត។",
        "qi": "ថាមពល Yin Wood ផ្តល់នូវភាពបត់បែន និងសមត្ថភាពចរចាពាណិជ្ជកម្មជោគជ័យ។",
        "time": "ក្នុងយុគទី ៩ ទិសអាគ្នេយ៍ជាទិស Zhao Shen (照神) ដ៏មានឥទ្ធិពលសម្រាប់ការស្រូបលាភ។",
        "bazi": "ជួយទ្រទ្រង់ Day Master ធាតុ Yi Wood។",
        "taboo": "ហាមដាក់បង្គន់ ឬកន្លែងចាក់សម្រាមនៅទិសអាគ្នេយ៍ (SE) ព្រោះនាំឱ្យធ្លាយលុយកាក់។"
    },
    {
        ...
        "formula": "坎为水、为沟渎、为隐伏、为矫輮、为弓轮、为加忧、为心病、为耳痛。",
        "remedy": "ក្នុងយុគទី ៩ (2024-2043) ទិសខាងជើងជាទិសសូន្យ (Ling Shen 零神) ល្អបំផុតសម្រាប់ការដាក់ទឹកហូរស្រូបទ្រព្យធំ។",
        "geo": "ខាងក្រៅទិសខាងជើងត្រូវមានផ្លូវធំ ឬផ្ទៃទឹកទូលាយ (Ling Shen Water Palace)។",
        "qi": "ថាមពល Yin Water ផ្តល់នូវប្រាជ្ញាឈ្លាសវៃ និងការគិតស៊ីជម្រៅ។",
        "time": "ជាទិសដៅលេខ ១ ក្នុងការជំរុញទ្រព្យសម្បត្តិក្នុងយុគទី ៩ តាមក្បួន Ling Shen។",
        "bazi": "ជួយទ្រទ្រង់ Day Master ធាតុ Ren Water និង Gui Water។",
        "taboo": "ហាមបិទជញ្ជាំងជិតឈឹង ឬលើកដីទួលខ្ពស់នៅទិសខាងជើងក្នុងយុគទី ៩ (ស្ទះលំហូរទឹក Ling Shen)។"
    },
    {
        ...
        "formula": "离为火、为日、为电、为中女、为甲胄、为戈兵。离者丽也，日月丽乎天。",
        "remedy": "ក្នុងយុគទី ៩ ទិសខាងត្បូងជាទិស Zheng Shen (正神) ត្រូវការភ្នំ ឬជញ្ជាំងរឹងមាំ មិនត្រូវមានទឹកជ្រៅឡើយ។",
        "geo": "ខាងក្រោយទិសខាងត្បូងត្រូវមានជញ្ជាំងរឹងមាំ ឬអគារខ្ពស់ទ្រពីក្រោយ។",
        "qi": "ថាមពល Yang Fire ផ្តល់នូវភាពល្បីល្បាញ កិត្តិយស និងភាពទាក់ទាញខ្លាំង។",
        "time": "គ្រប់គ្រងផ្ទាល់លើទូទាំងយុគទី ៩ (2024-2043) ទាំងមូល។",
        "bazi": "ជួយទ្រទ្រង់ Day Master ធាតុ Bing Fire និង Ding Fire។",
        "taboo": "ហាមដាក់អាងទឹកជ្រៅ ឬចាក់ទឹកហូរខ្លាំងនៅទិសខាងត្បូងក្នុងយុគទី ៩ (Zheng Shen Water Clash)។"
    },
    {
        ...
        "formula": "艮为山、为径路、为小石、为门阙、为果蓏、为阍寺、为指、为狗、为鼠。",
        "remedy": "រៀបចំទិសឦសានឱ្យមានភាពរឹងមាំ និងភ្លឺស្អាត ដើម្បីរក្សាស្ថិរភាពគ្រួសារ និងកុមារក្នុងផ្ទះ។",
        "geo": "ដីទិសឦសានត្រូវមានភាពរឹងមាំ មិនត្រូវបាក់ច្រោះ ឬមានរណ្តៅជ្រៅឡើយ។",
        "qi": "ថាមពល Yang Earth ផ្តល់នូវការតស៊ូ អត់ធ្មត់ និងការប្រមូលផ្តុំទ្រព្យអចលនវត្ថុ។",
        "time": "យុគទី ៨ (2004-2023) បានកន្លងផុត ដូច្នេះទិស Gen ត្រូវរក្សាភាពស្ងប់ស្ងាត់។",
        "bazi": "ជួយពង្រឹងកម្លាំងដល់ Day Master ធាតុ Wu Earth។",
        "taboo": "ហាមជីកកកាយដីជ្រៅ ឬវាយកម្ទេចជញ្ជាំងទិសឦសានដោយគ្មានការគន់គូរថ្ងៃជ័យ។"
    },
    {
        ...
        "formula": "兑为泽、为少女、为巫、为口舌、为毁折、为附决。其于地也为刚卤。",
        "remedy": "ជៀសវាងវត្ថុមុតស្រួច ឬទ្រុឌទ្រោមនៅទិសខាងលិច ព្រោះអាចបណ្តាលឱ្យមានជម្លោះមាត់ក ឬគ្រោះថ្នាក់ដោយសារលោហៈ។",
        "geo": "ដីទិសខាងលិចត្រូវស្អាតបាត និងមានពន្លឺថ្ងៃរសៀលស្រាលៗ។",
        "qi": "ថាមពល Yin Metal ផ្តល់នូវវោហារស័ព្ទ ការទាក់ទាញ និងភាពរីករាយ។",
        "time": "ក្នុងយុគទី ៩ ធាតុភ្លើងអាចរំលាយធាតុលោហៈ Dui ដូច្នេះត្រូវបន្ថែមធាតុដីទ្រទ្រង់។",
        "bazi": "ជួយទ្រទ្រង់ Day Master ធាតុ Xin Metal។",
        "taboo": "ហាមទុកដែកច្រែះ ឬកាំបិតមុតស្រួចចង្អុលចេញក្រៅនៅទិសខាងលិច (W)។"
    },
    {
        ...
        "formula": "乘生气，避杀气，迎旺气，除死气。气聚则生，气散则死。",
        "remedy": "បើកទ្វារ និងបង្អួចឱ្យខ្យល់ និងពន្លឺចូល ដើម្បីបណ្តេញ Si Qi ហើយដាក់រុក្ខជាតិស្រស់ដើម្បីស្រូប Sheng Qi។",
        "geo": "ដីជុំវិញផ្ទះត្រូវមានរុក្ខជាតិបៃតង និងខ្យល់អាកាសបរិសុទ្ធ។",
        "qi": "ការបម្លែង Sha Qi និង Si Qi ឱ្យទៅជា Sheng Qi ដោយការបង្វែរមុំខ្យល់ និងពន្លឺ។",
        "time": "ក្នុងយុគទី ៩ តារា ៩ ជា Wang Qi ហើយតារា ១ ជា Sheng Qi។",
        "bazi": "ជួយឱ្យជោគជតារាសីមានកម្លាំងថាមពលស្រស់ថ្លាជានិច្ច។",
        "taboo": "ហាមបិទផ្ទះចោលងងឹតស្លុបគ្មានមនុស្សនៅយូរថ្ងៃ (ប្រមូលផ្តុំ Si Qi និង Yin Sha)។"
    },
    {
        "id": 17, "cat": "CAT1", "name_kh": "រូបមន្ត Life Gua (San Yuan Ming Gua Formula)", "name_en": "San Yuan Ming Gua Calculation",
        "treatise": "《八宅明镜》 (Ba Zhai Ming Jing)",
        ...
        "geo": "ជ្រើសរើសទីតាំងអគារដែលត្រូវនឹងក្រុម Gua របស់មេគ្រួសារ។",
        "qi": "តម្រឹមដែនម៉ាញេទិចរាងកាយឱ្យស្របតាមដែនម៉ាញេទិចផែនដី។",
        "time": "Life Gua នីមួយៗមានអន្តរកម្មផ្សេងៗគ្នាក្នុងយុគទី ៩ ធាតុភ្លើង។",
        "bazi": "ជាស្ពានផ្សារភ្ជាប់រវាងផ្ទះ (Space) និងមនុស្ស (Man) ក្នុងទ្រឹស្តី Tien Ti Ren។",
        "taboo": "ហាមគេង ឬអង្គុយធ្វើការបែរមុខទៅទិស Jue Ming (ទិសវិនាស) នៃ Life Gua របស់ខ្លួន។"
    },
    {
        ...
        "formula": "东四命配东四宅，西四命配西四宅。宅命相配，吉庆有余；宅命相克，灾祸连连。",
        "remedy": "ប្រសិនបើប្តីប្រពន្ធនៅក្រុមផ្សេងគ្នា ឱ្យទ្វារធំត្រូវនឹងមេផ្ទះ រីឯទិសក្បាលគ្រែត្រូវនឹងអ្នកដែលមានសុខភាពខ្សោយជាង។",
        "geo": "បែងចែកទិសដៅទាំង ៨ ទៅតាមក្រុមបូព៌ា និងបស្ចិមយ៉ាងច្បាស់លាស់។",
        "qi": "ធានាថាមនុស្សក្រុមបូព៌ាស្រូប Qi ក្រុមបូព៌ា និងមនុស្សក្រុមបស្ចិមស្រូប Qi ក្រុមបស្ចិម។",
        "time": "ក្នុងយុគទី ៩ ទាំងក្រុមបូព៌ា និងបស្ចិមសុទ្ធតែអាចកែច្នៃទិសស្រូបទ្រព្យបានដោយប្រើ Ling Shen។",
        "bazi": "ជួយសម្របសម្រួលធាតុក្នុងគ្រួសារឱ្យមានសុខដុមរមនា។",
        "taboo": "ហាមមេគ្រួសារក្រុមបូព៌ារស់នៅផ្ទះបែរទៅទិសបស្ចិមសុទ្ធសាធដោយគ្មានការកែតម្រូវទ្វារបន្ទប់។"
    },
    {
        ...
        "formula": "生气贪狼木，天医巨门土，延年武曲金，伏位辅弼木。四吉临门，富贵双全。",
        "remedy": "តម្រង់ក្បាលគ្រែទៅទិស Tian Yi សម្រាប់អ្នកឈឺ ឬទិស Yan Nian សម្រាប់គូស្វាមីភរិយា។",
        "geo": "រៀបចំទ្វារធំ បន្ទប់ទទួលភ្ញៀវ និងបន្ទប់គេងមេនៅទិសល្អទាំង ៤។",
        "qi": "ស្រូបយកថាមពលវិជ្ជមានដែលជំរុញទាំងទ្រព្យ សុខភាព និងទំនាក់ទំនង។",
        "time": "យុគទី ៩ បង្កើនកម្លាំងដល់ទិស Sheng Qi និង Yan Nian ឱ្យកាន់តែរហ័ស។",
        "bazi": "ជួយពង្រឹងរាសី និងការពារពីឥទ្ធិពលអាក្រក់នៃឆ្នាំឆុង។",
        "taboo": "ហាមដាក់បន្ទប់ទឹក បង្គន់ ឬធុងសំរាមនៅចំទិស Sheng Qi របស់មេគ្រួសារ។"
    },
    {
        ...
        "formula": "绝命破军金，五鬼廉贞火，六煞文曲水，祸害禄存土。以煞制煞，凶位安厨厕。",
        "remedy": "ដាក់បន្ទប់ទឹក ឬឃ្លាំងនៅទិសអាក្រក់ទាំង ៤ ដើម្បីសង្កត់កម្ចាត់គ្រោះ (Suppressing Evil Qi with Utilities)។",
        "geo": "កំណត់ទីតាំងអវិជ្ជមាននៃដីដើម្បីរៀបចំជាកន្លែងចោលកាកសំណល់ ឬបន្ទប់ទឹក។",
        "qi": "បន្សាបថាមពល Sha Qi កុំឱ្យជ្រាបចូលក្នុងបន្ទប់គេង ឬទ្វារធំ។",
        "time": "តាមដានចលនាតារាប្រចាំឆ្នាំកុំឱ្យជាន់លើទិស Jue Ming ឬ Wu Gui។",
        "bazi": "ជួយការពារម្ចាស់ផ្ទះពីគ្រោះថ្នាក់ដែលបណ្តាលមកពីទិសអាក្រក់។",
        "taboo": "ហាមដាក់ទ្វារធំ ឬក្បាលគ្រែមេគ្រួសារនៅចំទិស Jue Ming (絕命) ជាដាច់ខាត។"
    }
]

# Generate detailed metadata for topics 21 to 100 with comprehensive domain mapping
for tid in range(21, 101):
    if tid <= 50:
        cat = "CAT2"
    elif tid <= 80:
        cat = "CAT3"
    ...
    # Specific topic mapping for Category 2, 3, 4
    if tid == 21:
        ...
        name_kh, name_en, treatise, essence, formula, remedy, geo, qi, time, bazi, taboo = (
            "យុគសម័យទាំង ៩ (San Yuan Jiu Yun - 180 Year Cycle)", "Nine Periods of the 180-Year Macrocycle",
            "《玄空大卦·三元九运篇》",
        ...
        name_kh, name_en, treatise, essence, formula, remedy, geo, qi, time, bazi, taboo = (
            "តារា ៩ ស្វាយ (Star 9 Purple - Period 9 Supreme Wealth)", "Star 9 Purple Supreme",
            "《玄空秘旨》：九紫离火，喜庆显达，当令最吉。",
        ...
        name_kh, name_en, treatise, essence, formula, remedy, geo, qi, time, bazi, taboo = (
            "ការរៀបចំបន្ទប់គេង និងទិសដៅក្បាលគ្រែ (Master Bedroom)", "Master Bedroom Placement",
        ...
        name_kh, name_en, treatise, essence, formula, remedy, geo, qi, time, bazi, taboo = (
            "ការរៀបចំផ្ទះបាយ និងចង្ក្រានបាយ (Kitchen & Stove)", "Kitchen Stove Wealth Alignment",
        ...
        name_kh, name_en, treatise, essence, formula, remedy, geo, qi, time, bazi, taboo = (
            "សសរស្តម្ភទាំង ៤ BaZi (Four Pillars of Destiny)", "BaZi Four Pillars Structure",
        ...
        name_kh, name_en, treatise, essence, formula, remedy, geo, qi, time, bazi, taboo = (
            "ការបើកឃ្លាំងទ្រព្យទាំង ៤ ក្នុង BaZi (Wealth Vaults)", "Activating 4 Earth Wealth Vaults",
        ...
        name_kh, name_en, treatise, essence, formula, remedy, geo, qi, time, bazi, taboo = (
            "កំពូលមហាសំយោគ AGI Supreme Feng Shui Master Synthesis", "Supreme AGI Master Unified Matrix",
