...
class CelestialAstrologyEngine:
    ...
    DAY_OFFICERS_KH = [
        {"name": "ថ្ងៃកសាង", "quality_kh": "ថ្ងៃសិរីសួស្តី", "meaning": "ល្អសម្រាប់ការចាប់ផ្តើមគម្រោងថ្មី ចុះកិច្ចសន្យា និងបើកហាង", "detail": "ថាមពលមេឃដីកំពុងកកើតថ្មី ស័ក្តិសមបំផុតសម្រាប់ការបញ្ចុះបឋមសិលា ចាប់ផ្តើមអាជីវកម្ម ឬចុះហត្ថលេខាលើកិច្ចព្រមព្រៀងសំខាន់ៗ។", "kh": "ថ្ងៃកសាង", "quality": "ថ្ងៃសិរីសួស្តី"},
        {"name": "ថ្ងៃកម្ចាត់", "quality_kh": "ថ្ងៃសិរីសួស្តី", "meaning": "ល្អសម្រាប់ការបោសសម្អាត រុះរើ ព្យាបាលជំងឺ និងលាងជម្រះឧបទ្រព", "detail": "ថាមពលជួយរំលាយរឿងចាស់ៗមិនល្អ ស័ក្តិសមសម្រាប់ការសម្អាតផ្ទះ រុះរើកន្លែងចាស់ ព្យាបាលជំងឺ និងកាត់ផ្តាច់រឿងសៅហ្មង។", "kh": "ថ្ងៃកម្ចាត់", "quality": "ថ្ងៃសិរីសួស្តី"},
        {"name": "ថ្ងៃពេញលេញ", "quality_kh": "ថ្ងៃមហាសិទ្ធិជោគ", "meaning": "ល្អសម្រាប់ការប្រមូលផល បើកសម្ពោធ ទទួលទ្រព្យ និងរៀបមង្គលការ", "detail": "ថាមពលទ្រព្យពេញបរិបូរណ៍ ស័ក្តិសមសម្រាប់ការប្រមូលផលចំណេញ បើកសម្ពោធសាខាថ្មី រៀបមង្គលការ និងទទួលផលវិនិយោគ។", "kh": "ថ្ងៃពេញលេញ", "quality": "ថ្ងៃមហាសិទ្ធិជោគ"},
        {"name": "ថ្ងៃស្មើភាព", "quality_kh": "ថ្ងៃមធ្យម", "meaning": "ល្អសម្រាប់ការសម្រុះសម្រួល ជួសជុល និងកិច្ចការទូទៅ", "detail": "ថាមពលមានតុល្យភាពស្មើគ្នា ល្អសម្រាប់ការចរចាសម្រុះសម្រួលទំនាស់ ជួសជុលគេហដ្ឋាន និងការងាររដ្ឋបាលប្រចាំថ្ងៃ។", "kh": "ថ្ងៃស្មើភាព", "quality": "ថ្ងៃមធ្យម"},
        {"name": "ថ្ងៃកំណត់", "quality_kh": "ថ្ងៃសិរីសួស្តី", "meaning": "ល្អសម្រាប់ការចុះហត្ថលេខា ភ្ជាប់ពាក្យ រៀបការ និងទិញអចលនទ្រព្យ", "detail": "ថាមពលមានស្ថិរភាពរឹងមាំយូរអង្វែង ល្អសម្រាប់កិច្ចសន្យារយៈពេលវែង ការភ្ជាប់ពាក្យ អាពាហ៍ពិពាហ៍ និងការទិញដីធ្លីផ្ទះសម្បែង។", "kh": "ថ្ងៃកំណត់", "quality": "ថ្ងៃសិរីសួស្តី"},
        {"name": "ថ្ងៃកាន់កាប់", "quality_kh": "ថ្ងៃមធ្យម", "meaning": "ល្អសម្រាប់ការចាប់ផ្តើមសាងសង់ ចាប់កំណើត និងដាំដំណាំ", "detail": "ថាមពលរក្សាទ្រព្យ និងថែរក្សាកេរដំណែល ល្អសម្រាប់ការចាប់ផ្តើមការងារកសិកម្ម សាងសង់ និងការប្រគល់ភារកិច្ច។", "kh": "ថ្ងៃកាន់កាប់", "quality": "ថ្ងៃមធ្យម"},
        {"name": "ថ្ងៃបំបែក", "quality_kh": "ថ្ងៃគួរប្រុងប្រយ័ត្ន", "meaning": "ហាមដាច់ខាតកិច្ចការមង្គល ធ្វើដំណើរ ឬបើកអាជីវកម្ម។ ល្អសម្រាប់តែកម្ទេចសំណង់ចាស់", "detail": "ថាមពលបែកបាក់ និងប៉ះទង្គិច ត្រូវជៀសវាងពិធីមង្គល ការចុះហត្ថលេខា និងការធ្វើដំណើរឆ្ងាយ។ ល្អសម្រាប់តែកម្ទេចសំណង់ចាស់ៗចោល។", "kh": "ថ្ងៃបំបែក", "quality": "ថ្ងៃគួរប្រុងប្រយ័ត្ន"},
        {"name": "ថ្ងៃគ្រោះថ្នាក់", "quality_kh": "ថ្ងៃគួរប្រុងប្រយ័ត្ន", "meaning": "ប្រុងប្រយ័ត្នក្នុងការធ្វើដំណើរឆ្ងាយ និងកីឡាគ្រោះថ្នាក់។ ល្អសម្រាប់ការបួងសួង", "detail": "ថាមពលមិនទាន់នឹងនរ គួរប្រយ័ត្នក្នុងការបើកបរ និងការសម្រេចចិត្តហិរញ្ញវត្ថុប្រថុយប្រថាន។ ស័ក្តិសមសម្រាប់ការធ្វើសមាធិ និងបួងសួងសុំសេចក្តីសុខ។", "kh": "ថ្ងៃគ្រោះថ្នាក់", "quality": "ថ្ងៃគួរប្រុងប្រយ័ត្ន"},
        {"name": "ថ្ងៃជោគជ័យ", "quality_kh": "ថ្ងៃមហាសិទ្ធិជោគកំពូល", "meaning": "ថ្ងៃមហាសិទ្ធិជោគ! ល្អបំផុតសម្រាប់ការបើកហាង រៀបការ ចុះកិច្ចសន្យា និងឡើងផ្ទះថ្មី", "detail": "ថាមពលជោគជ័យពេញទំហឹង ធ្វើកិច្ចការអ្វីក៏ទទួលបានផលល្អហួសពីការស្មាន ទាំងទ្រព្យសម្បត្តិ កិត្តិយស និងសុភមង្គល។", "kh": "ថ្ងៃជោគជ័យ", "quality": "ថ្ងៃមហាសិទ្ធិជោគកំពូល"},
        {"name": "ថ្ងៃប្រមូលផល", "quality_kh": "ថ្ងៃសិរីសួស្តី", "meaning": "ល្អសម្រាប់ការទារបំណុល ប្រមូលផលចំណេញ និងទទួលបុគ្គលិក", "detail": "ថាមពលច្រូតកាត់ផលលាភ ល្អសម្រាប់ការទារបំណុល ប្រមូលប្រាក់ចំណេញ ទទួលបុគ្គលិកថ្មី និងការចូលកាន់កាប់ទ្រព្យសម្បត្តិ។", "kh": "ថ្ងៃប្រមូលផល", "quality": "ថ្ងៃសិរីសួស្តី"},
        {"name": "ថ្ងៃបើកចំហ", "quality_kh": "ថ្ងៃមហាសិទ្ធិជោគកំពូល", "meaning": "ល្អសម្រាប់ពិធីសម្ពោធ បើកទំព័រជីវិតថ្មី ចូលកាន់តំណែង និងធ្វើដំណើរ", "detail": "ថាមពលទ្វារមេឃបើកចំហទទួលលាភ ស័ក្តិសមបំផុតសម្រាប់ពិធីសម្ពោធ បើកហាងថ្មី ឡើងកាន់តំណែង ការចេញដំណើរទៅក្រៅប្រទេស និងការរៀនសូត្រ។", "kh": "ថ្ងៃបើកចំហ", "quality": "ថ្ងៃមហាសិទ្ធិជោគកំពូល"},
        {"name": "ថ្ងៃបិទ", "quality_kh": "ថ្ងៃគួរប្រុងប្រយ័ត្ន", "meaning": "ហាមកិច្ចការមង្គល និងពិធីបើកសម្ពោធ។ ល្អសម្រាប់តែការបញ្ចុះសព និងការធ្វើសមាធិ", "detail": "ថាមពលស្រូបទាញចូលក្នុង ហាមដាច់ខាតការបើកសម្ពោធ និងពិធីមង្គលនានា។ ល្អសម្រាប់ការសម្រាក សមាធិ និងការបិទបញ្ជីគណនេយ្យ។", "kh": "ថ្ងៃបិទ", "quality": "ថ្ងៃគួរប្រុងប្រយ័ត្ន"}
    ]
    ...
    def calculate_precision_bazi(
        ...
        dm_element_raw = day_master.get("element", "Wood")
        
        # Clean element string to pure 5 Elements (Wood, Fire, Earth, Metal, Water)
        dm_element = "Wood"
        for k in ["Water", "Wood", "Fire", "Earth", "Metal"]:
            if k.lower() in dm_element_raw.lower():
                dm_element = k
                break
        ...
        # Solar year cutoff for Life Gua (Li Chun via calc_engine)
        b_year = int(birth_date.split("-")[0]) if "-" in birth_date else 1990
        gua_res = self.calc_engine.calculate_life_gua(birth_year=b_year, gender=gender, birth_date=birth_date)
    ...
    def calculate_global_almanac(self, target_date: Optional[date] = None) -> Dict[str, Any]:
        ...
        # Reference: 2000-01-01 was Wu-Wu (戊午 - Stem index 4, Branch index 6)
        stem_idx = (days_since_ref + 4) % 10
        ...
        # 12 Day Officers (Dong Gong Ze Ri - 董公择日):
        # Day whose branch matches the Solar Term Month Branch is Jian (建 - Officer 0)
        bazi_res = self.calc_engine.calculate_bazi(now.strftime("%Y-%m-%d"), "12:00")
        month_branch = bazi_res["data"]["pillars"]["month"]["branch"]
        month_branch_idx = self.EARTHLY_BRANCHES.index(month_branch) if month_branch in self.EARTHLY_BRANCHES else (now.month % 12)

        officer_idx = (branch_idx - month_branch_idx) % 12
        officer = self.DAY_OFFICERS_KH[officer_idx]

        # 28 Lunar Mansions (二十八星宿)
        # Reference: 2000-01-01 was 胃 (Wei - index 16 in CONSTELLATIONS_28_KH)
        if LUNAR_AVAILABLE:
            try:
                solar_obj = Solar.fromYmd(now.year, now.month, now.day)
                lunar_obj = solar_obj.getLunar()
                xiu_char = lunar_obj.getXiu()
                xiu_map = {
                ...
                constellation_idx = xiu_map.get(xiu_char, (days_since_ref + 16) % 28)
            except Exception:
                constellation_idx = (days_since_ref + 16) % 28
        else:
            constellation_idx = (days_since_ref + 16) % 28
        ...
        khmer_qualities = [
            ...
            "ថ្ងៃជ័យជោគ (ថ្ងៃមានជ័យជំនះលើឧបសគ្គ)",
            "ថ្ងៃរាជជោគ (ថ្ងៃកិត្តិយស ឡើងបុណ្យស័ក្តិ)"
        ]
        khmer_day_status = khmer_qualities[(now.day * 2 + now.month + day_of_week) % len(khmer_qualities)]
        if officer["quality_kh"] == "ថ្ងៃគួរប្រុងប្រយ័ត្ន":
            khmer_inauspicious = [
                "ថ្ងៃគួរប្រុងប្រយ័ត្ន ថ្ងៃពិឃាត (ជៀសវាងការចាប់ផ្តើមការងារធំ)",
                "ថ្ងៃគួរប្រុងប្រយ័ត្ន ថ្ងៃយមខាន់ (ជៀសវាងការធ្វើដំណើរឆ្ងាយ និងការប្រថុយប្រថាន)",
                "ថ្ងៃគួរប្រុងប្រយ័ត្ន ថ្ងៃវិនាស (ជៀសវាងការចុះហត្ថលេខា និងវិនិយោគ)",
                "ថ្ងៃគួរប្រុងប្រយ័ត្ន ថ្ងៃឧបទ្រព (ជៀសវាងជម្លោះ និងកិច្ចការមង្គល)"
            ]
            khmer_day_status = khmer_inauspicious[(now.day + branch_idx) % len(khmer_inauspicious)]

        # Classical Chinese Metaphysics Almanac Directions (董公择日 & 通书)
        # 1. Wealth God (财神方位歌: 甲乙东北, 丙丁西南, 戊己正北, 庚辛正东, 壬癸正南)
        cai_shen_map = {
            "甲": "ទិសឦសាន (东北)", "乙": "ទិសឦសាន (东北)",
            "丙": "ទិសនិរតី (西南)", "丁": "ទិសនិរតី (西南)",
            "戊": "ទិសខាងជើង (正北)", "己": "ទិសខាងជើង (正北)",
            "庚": "ទិសខាងកើត (正东)", "辛": "ទិសខាងកើត (正东)",
            "壬": "ទិសខាងត្បូង (正南)", "癸": "ទិសខាងត្បូង (正南)"
        }
        wealth_dir = cai_shen_map.get(day_stem, "ទិសខាងជើង (正北)")

        # 2. Joy God (喜神方位歌: 甲己东北, 乙庚西北, 丙辛西南, 丁壬正南, 戊癸东南)
        xi_shen_map = {
            "甲": "ទិសឦសាន (东北)", "己": "ទិសឦសាន (东北)",
            "乙": "ទិសពាយព្យ (西北)", "庚": "ទិសពាយព្យ (西北)",
            "丙": "ទិសនិរតី (西南)", "辛": "ទិសនិរតី (西南)",
            "丁": "ទិសខាងត្បូង (正南)", "壬": "ទិសខាងត្បូង (正南)",
            "戊": "ទិសអាគ្នេយ៍ (东南)", "癸": "ទិសអាគ្នេយ៍ (东南)"
        }
        joy_dir = xi_shen_map.get(day_stem, "ទិសខាងត្បូង (正南)")

        # 3. Nobleman God (阳贵人/阴贵人歌: 甲戊牛羊, 乙己鼠猴, 丙丁猪鸡, 壬癸兔蛇, 庚辛虎马)
        gui_ren_map = {
            "甲": "ទិសឦសាន / និរតី (丑/未)", "戊": "ទិសឦសាន / និរតី (丑/未)",
            "乙": "ទិសខាងជើង / និរតី (子/申)", "己": "ទិសខាងជើង / និរតី (子/申)",
            "丙": "ទិសពាយព្យ / ខាងលិច (亥/酉)", "丁": "ទិសពាយព្យ / ខាងលិច (亥/酉)",
            "庚": "ទិសឦសាន / ខាងត្បូង (寅/午)", "辛": "ទិសឦសាន / ខាងត្បូង (寅/午)",
            "壬": "ទិសខាងកើត / អាគ្នេយ៍ (卯/巳)", "癸": "ទិសខាងកើត / អាគ្នេយ៍ (卯/巳)"
        }
        nobleman_dir = gui_ren_map.get(day_stem, "ទិសឦសាន / និរតី (丑/未)")

        # 4. Three Killings (三煞方位: 寅午戌煞北, 申子辰煞南, 亥卯未煞西, 巳酉丑煞东)
        san_sha_map = {
            "寅": "ទិសខាងជើង (煞北)", "午": "ទិសខាងជើង (煞北)", "戌": "ទិសខាងជើង (煞北)",
            "申": "ទិសខាងត្បូង (煞南)", "子": "ទិសខាងត្បូង (煞南)", "辰": "ទិសខាងត្បូង (煞南)",
            "亥": "ទិសខាងលិច (煞西)", "卯": "ទិសខាងលិច (煞西)", "未": "ទិសខាងលិច (煞西)",
            "巳": "ទិសខាងកើត (煞东)", "酉": "ទិសខាងកើត (煞东)", "丑": "ទិសខាងកើត (煞东)"
        }
        inauspicious_dir = san_sha_map.get(day_branch, "ទិសខាងជើង (煞北)")
    ...
    def calculate_hourly_timeline(self, user_day_master_element: str, target_date: Optional[date] = None) -> List[Dict[str, Any]]:
        ...
        # Clean user_day_master_element to standard 5 Elements
        clean_dm = "Wood"
        for k in ["Water", "Wood", "Fire", "Earth", "Metal"]:
            if k.lower() in str(user_day_master_element).lower():
                clean_dm = k
                break

        element_relations = {
            "Wood": {"Water": 95, "Wood": 90, "Fire": 85, "Earth": 70, "Metal": 60},
            "Fire": {"Wood": 95, "Fire": 90, "Earth": 85, "Metal": 70, "Water": 60},
            "Earth": {"Fire": 95, "Earth": 90, "Metal": 85, "Water": 70, "Wood": 60},
            "Metal": {"Earth": 95, "Metal": 90, "Water": 85, "Wood": 70, "Fire": 60},
            "Water": {"Metal": 95, "Water": 90, "Wood": 85, "Fire": 70, "Earth": 60}
        }

        # Dynamic advice matrix for distinct and relevant guidance per double-hour
        advice_matrix = {
            "clash": "ម៉ោងឆុងប្រចាំថ្ងៃ ជៀសវាងការបើកបរលឿន ការឈ្លោះប្រកែក ការចរចាហិរញ្ញវត្ថុ ឬការចុះហត្ថលេខាសំខាន់",
            "great": [
                "ល្អបំផុតសម្រាប់ការជួបអតិថិជន ចរចាជំនួញធំៗ ចុះកិច្ចសន្យា ឬបួងសួងសុំលាភសក្ការៈ",
                "ថាមពលមហាលាភខ្ពស់ ស័ក្តិសមសម្រាប់ការបើកសម្ពោធ ចាប់ផ្តើមគម្រោងថ្មី និងវិនិយោគ",
                "វេលាលាភជ័យជំនះ ល្អសម្រាប់ការដោះស្រាយកិច្ចការលំបាកៗ និងពិភាក្សាជាមួយដៃគូពាណិជ្ជកម្ម",
                "រាសីឡើងខ្ពស់ត្រដែត ស័ក្តិសមសម្រាប់ការបង្ហាញសមត្ថភាព ដឹកនាំក្រុម និងទំនាក់ទំនងការទូត",
                "ឱកាសមាសសម្រាប់ការប្រមូលទ្រព្យ បង្កើតចំណូលបន្ថែម និងពង្រីកបណ្តាញអតិថិជន",
                "សិរីសួស្តីភ្លឺថ្លា ល្អសម្រាប់ការសម្រេចចិត្តសំខាន់ៗ និងរៀបចំយុទ្ធសាស្ត្ររយៈពេលវែង"
            ],
            "auspicious": {
                "Water": "ល្អសម្រាប់ការស្រាវជ្រាវ ការរៀនសូត្រ ប្រជុំយុទ្ធសាស្ត្រ និងការពិគ្រោះយោបល់ស៊ីជម្រៅ",
                "Wood": "ល្អសម្រាប់ការទំនាក់ទំនង បង្កើតបណ្តាញដៃគូថ្មីៗ និងការសហការបំពេញការងារជាក្រុម",
                "Fire": "ល្អសម្រាប់ការធ្វើបទបង្ហាញ ការផ្សព្វផ្សាយទីផ្សារ និងការបញ្ចេញគំនិតច្នៃប្រឌិតថ្មី",
                "Earth": "ល្អសម្រាប់ការរៀបចំឯកសាររដ្ឋបាល គ្រប់គ្រងទ្រព្យសម្បត្តិ និងពិនិត្យកិច្ចសន្យា",
                "Metal": "ល្អសម្រាប់ការសម្រេចចិត្តម៉ឺងម៉ាត់ រៀបចំផែនការដឹកនាំ និងចាត់ចែងភារកិច្ចឱ្យមានសណ្តាប់ធ្នាប់"
            },
            "neutral": [
                "បំពេញកិច្ចការប្រចាំថ្ងៃដោយស្ងប់ចិត្ត ផ្ទៀងផ្ទាត់រាល់ព័ត៌មានលម្អិត និងសម្រាកឱ្យបានគ្រប់គ្រាន់",
                "ដំណើរការកិច្ចការធម្មតា រក្សាភាពនឹងនរក្នុងអារម្មណ៍ និងជៀសវាងការប្រញាប់ប្រញាល់ជ្រុល"
            ]
        }
        ...
        for i, dh in enumerate(self.DOUBLE_HOURS):
            ...
            base_score = element_relations.get(clean_dm, {}).get(hour_elem, 75)
            
            # 1. Direct Clash with Day Branch (日破 / 时冲 - Six Clashes 六冲)
            if (i - day_branch_idx) % 6 == 0 and (i != day_branch_idx):
                base_score = max(30, min(48, base_score - 45))
                nature = "ម៉ោងគ្រោះ ឬទាស់ (គួរប្រុងប្រយ័ត្នខ្ពស់)"
                action_advice = advice_matrix["clash"]
            # 2. Harmonies (三合 / 六合)
            elif (i - day_branch_idx) % 4 == 0 or abs(i - day_branch_idx) in [1, 11]:
                base_score = min(98, max(88, base_score + 15))
                nature = "ម៉ោងមហាសិទ្ធិជោគ (ម៉ោងលាភធំ)"
                action_advice = advice_matrix["great"][i % len(advice_matrix["great"])]
            elif base_score >= 80:
                nature = "ម៉ោងសិរីសួស្តី"
                action_advice = advice_matrix["auspicious"].get(hour_elem, "ល្អសម្រាប់ការងាររដ្ឋបាល និងកិច្ចការទូទៅ")
            else:
                nature = "ម៉ោងមធ្យម"
                action_advice = advice_matrix["neutral"][i % len(advice_matrix["neutral"])]
    ...
    def generate_daily_celestial_report(
        ...
        best_hours = sorted([t for t in timeline if t["score"] >= 85], key=lambda x: -x["score"])
        best_hours_str = "\n".join([f"  ⏰ {b['interval']} ({b['name']}): {b['advice']}" for b in best_hours[:3]])
        
        # Sort clash hours so that direct clash hours come first, then lowest scores
        clash_hours = sorted(
            [t for t in timeline if "គ្រោះ" in t["nature"] or t["score"] < 70],
            key=lambda x: (0 if "គ្រោះ" in x["nature"] else 1, x["score"])
        )
        clash_hours_str = "\n".join([f"  ⚠️ {c['interval']} ({c['name']}): {c['advice']}" for c in clash_hours[:2]]) or "  ⚠️ គ្មានម៉ោងគ្រោះធ្ងន់ធ្ងរក្នុងថ្ងៃនេះឡើយ"

        # Determine 10 Gods relationship between User Day Master and Today's Stem/Branch
        GEN_CYCLE = {"Wood": "Fire", "Fire": "Earth", "Earth": "Metal", "Metal": "Water", "Water": "Wood"}
        CTRL_CYCLE = {"Wood": "Earth", "Fire": "Metal", "Earth": "Water", "Metal": "Wood", "Water": "Fire"}
        INV_GEN = {v: k for k, v in GEN_CYCLE.items()}
        INV_CTRL = {v: k for k, v in CTRL_CYCLE.items()}

        day_stem = almanac["day_ganzhi"][0] if almanac["day_ganzhi"] else "甲"
        day_branch = almanac["day_ganzhi"][1] if len(almanac["day_ganzhi"]) > 1 else "子"
        ...
        today_stem_elem = stem_elem_map.get(day_stem, "Water")
        today_branch_elem = branch_elem_map.get(day_branch, "Fire")
        today_stem_elem_kh = self.ELEMENT_NAMES_KH.get(today_stem_elem, "ធាតុទឹក")
        today_branch_elem_kh = self.ELEMENT_NAMES_KH.get(today_branch_elem, "ធាតុភ្លើង")

        def get_ten_god_relation(dm_e: str, target_e: str) -> str:
            if target_e == dm_e:
                return "companion"
            elif GEN_CYCLE.get(dm_e) == target_e:
                return "output"
            elif CTRL_CYCLE.get(dm_e) == target_e:
                return "wealth"
            elif INV_GEN.get(dm_e) == target_e:
                return "resource"
            elif INV_CTRL.get(dm_e) == target_e:
                return "officer"
            return "companion"

        stem_rel = get_ten_god_relation(dm_elem, today_stem_elem)
        branch_rel = get_ten_god_relation(dm_elem, today_branch_elem)

        wealth_text_map = {
            "wealth": f"សម្រាប់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh} ថាមពល{today_stem_elem_kh}នៃថ្ងៃនេះតំណាងឱ្យឃ្លាំងទ្រព្យ និងលំហូរសាច់ប្រាក់ផ្ទាល់។ ការលក់ដូរ ការចរចាពាណិជ្ជកម្ម និងការប្រមូលផលចំណេញពីការវិនិយោគមានសន្ទុះខ្លាំងក្លាគួរជាទីពេញចិត្ត។ គួរទាញយកប្រយោជន៍ពីឱកាសនេះដើម្បីប្រមូលបំណុលចាស់ៗ បិទកិច្ចសន្យាថ្មី និងពង្រីកមូលដ្ឋានអតិថិជនប្រកបដោយការប្រុងប្រយ័ត្ន។",
            "resource": f"សម្រាប់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh} ថាមពល{today_stem_elem_kh}នៃមេឃាថ្ងៃនេះដើរតួជាថាមពលចិញ្ចឹមរាសី និងបញ្ញាញាណយ៉ាងបរិបូរណ៍។ លំហូរសាច់ប្រាក់មានភាពរលូន និងមានស្ថិរភាពខ្ពស់ តាមរយៈគំនិតច្នៃប្រឌិត និងការជួយជ្រោមជ្រែងពីមនុស្សខ្ពង់ខ្ពស់ ឬអតិថិជនចាស់ៗ។ ឱកាសចំណេញកើតចេញពីការវិនិយោគចំណេះដឹង និងកិច្ចសន្យារយៈពេលវែង។ គួរផ្តោតលើការគ្រប់គ្រងទ្រព្យសម្បត្តិឱ្យមានលំនឹង និងជៀសវាងការចំណាយលើសម្ភារៈមិនចាំបាច់។",
            "output": f"សម្រាប់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh} ថាមពល{today_stem_elem_kh}នៃថ្ងៃនេះដើរតួជាផ្កាយបញ្ចេញសមត្ថភាព និងភាពវៃឆ្លាត។ ការបញ្ចេញគំនិតច្នៃប្រឌិត ការផ្សព្វផ្សាយពាណិជ្ជកម្ម និងការចរចាបង្កើតប្រភពចំណូលថ្មីៗផ្តល់ផ្លែផ្កាល្អប្រសើរ។ លំហូរហិរញ្ញវត្ថុមានការកើនឡើងតាមរយៈទេពកោសល្យ និងការចាប់យកឱកាសទីផ្សារថ្មីៗ។",
            "companion": f"សម្រាប់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh} ថាមពល{today_stem_elem_kh}នៃថ្ងៃនេះតំណាងឱ្យបណ្តាញមិត្តភក្តិ និងដៃគូសហការ។ លោកអ្នកមានឱកាសទទួលបានព័ត៌មានវិនិយោគដ៏មានតម្លៃពីសហការី ឬមិត្តភក្តិជិតស្និទ្ធ។ ទោះជាយ៉ាងណា គួរប្រុងប្រយ័ត្នក្នុងការឱ្យខ្ចីបុល ឬការវិនិយោគរួមគ្នាដោយគ្មានកិច្ចសន្យាច្បាស់លាស់ដើម្បីការពារលំហូរសាច់ប្រាក់។",
            "officer": f"សម្រាប់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh} ថាមពល{today_stem_elem_kh}នៃថ្ងៃនេះនាំមកនូវវិន័យ និងការគ្រប់គ្រងហិរញ្ញវត្ថុយ៉ាងម៉ឺងម៉ាត់។ ការគ្រប់គ្រងចំណូលចំណាយមានភាពច្បាស់លាស់។ លោកអ្នកអាចទទួលបានផលប្រយោជន៍ពីគម្រោងការងារធំៗ ឬការគាំទ្រពីស្ថាប័នផ្លូវការ។"
        }
        wealth_text = wealth_text_map.get(stem_rel, wealth_text_map["resource"])

        career_text_map = {
            "officer": f"ក្នុងវិស័យអាជីពការងារ ថាមពល{today_branch_elem_kh}នៃថ្ងៃជួយពង្រឹងអំណាចដឹកនាំ និងការទទួលខុសត្រូវខ្ពស់របស់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh}។ ការសម្រេចចិត្តដ៏ម៉ឺងម៉ាត់ជួយដោះស្រាយបញ្ហាស្មុគស្មាញបានយ៉ាងរលូន។ ឱកាសឡើងតំណែង ឬទទួលបានការជឿទុកចិត្តពីថ្នាក់ដឹកនាំមានសន្ទុះខ្លាំង។",
            "output": f"ក្នុងវិស័យអាជីពការងារ ថាមពល{today_branch_elem_kh}នៃសាខាថ្ងៃជួយជម្រុញភាពស្វាហាប់ និងភាពប៉ិនប្រសប់របស់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh}ឱ្យលេចធ្លោខ្លាំង។ ការធ្វើបទបង្ហាញ ការប្រជុំយុទ្ធសាស្ត្រ និងការដោះស្រាយបញ្ហាស្មុគស្មាញទទួលបានការគាំទ្រពេញទំហឹងពីថ្នាក់ដឹកនាំ និងសហការី។ ចូររក្សាភាពបត់បែន និងបើកចិត្តទទួលយកទស្សនៈថ្មីៗដើម្បីពង្រីកកិត្យានុភាពការងារ។",
            "resource": f"ក្នុងវិស័យអាជីពការងារ ម្ចាស់ជោគជតាធាតុ{dm_elem_kh}ទទួលបានការការពារ និងការជួយជ្រោមជ្រែងយ៉ាងកក់ក្តៅពីមនុស្សខ្ពង់ខ្ពស់។ គម្រោងការងារដែលធ្លាប់ជួបឧបសគ្គនឹងចាប់ផ្តើមដំណើរការទៅមុខវិញយ៉ាងរលូន។ ការរៀនសូត្រជំនាញបន្ថែម និងការស្តាប់ដំបូន្មានចាស់ទុំជាគន្លឹះឆ្ពោះទៅកាន់ជោគជ័យ។",
            "companion": f"ក្នុងវិស័យអាជីពការងារ កិច្ចសហការជាក្រុម និងការរួបរួមជាមួយសហការីជាកម្លាំងចលករដ៏សំខាន់របស់ម្ចាស់ជោគជតាធាតុ{dm_elem_kh}។ គម្រោងការងាររួមគ្នានឹងសម្រេចបានលទ្ធផលគួរជាទីពេញចិត្ត។ ចូររក្សាភាពស្មោះត្រង់ និងចែករំលែកផលប្រយោជន៍ឱ្យបានស្មើភាព។",
            "wealth": f"ក្នុងវិស័យអាជីពការងារ ម្ចាស់ជោគជតាធាតុ{dm_elem_kh}មានឱកាសកសាងសមិទ្ធផលការងារជាក់ស្តែងដែលបង្កើតផលចំណេញដល់ស្ថាប័ន។ ការចរចាជាមួយអតិថិជន និងដៃគូពាណិជ្ជកម្មទទួលបានជោគជ័យខ្ពស់។ ចូរផ្តោតលើការអនុវត្តជាក់ស្តែង និងត្រួតពិនិត្យព័ត៌មានលម្អិត។"
        }
        career_text = career_text_map.get(branch_rel, career_text_map["output"])

        love_text = {
            "Wood": "ផ្នែកសេចក្តីស្នេហា និងចំណងមិត្តភាពមានភាពកក់ក្តៅ និងយល់ចិត្តគ្នាកាន់តែស៊ីជម្រៅ។ សម្រាប់អ្នកមានគូស្នេហ៍ ការជជែកពិភាក្សាលើគម្រោងអនាគតរួមគ្នានឹងបង្កើតភាពស្និទ្ធស្នាលទ្វេដង។ សម្រាប់អ្នកនៅលីវ នឹងមានឱកាសជួបមនុស្សដែលត្រូវចិត្តតាមរយៈការងារ ឬការណែនាំពីមនុស្សចាស់ទុំ។",
        ...
        # Personalized Feng Shui element cures (Water for Wood, Light for Fire, Crystal for Earth, Metal for Metal, Flow for Water)
        element_remedies = {
            "Wood": f"ដាក់កែវទឹកស្អាតមួយកែវ ឬរុក្ខជាតិបៃតងតូចមួយនៅទិសខាងកើតនៃបន្ទប់ធ្វើការដើម្បីចិញ្ចឹមធាតុ {dm_elem_kh} និងស្រូបទាញថាមពលវិជ្ជមាន។",
            "Fire": f"បើកភ្លើងបំភ្លឺឱ្យបានគ្រប់គ្រាន់នៅទិសខាងត្បូង ឬប្រើប្រាស់គ្រឿងតុបតែងពណ៌ក្រហម/ឈើ ដើម្បីពង្រឹងធាតុ {dm_elem_kh} និងភាពលេចធ្លោ។",
            "Earth": f"ដាក់តម្កល់ថ្មធម្មជាតិ គ្រីស្តាល់ពណ៌លឿង ឬផើងដីដុតនៅទិសនិរតី ឬឦសានដើម្បីពង្រឹងគ្រឹះធាតុ {dm_elem_kh} ឱ្យកាន់តែរឹងមាំ។",
            "Metal": f"ដាក់កណ្តឹងខ្យល់លោហៈ វត្ថុធ្វើពីលោហធាតុពណ៌ស ឬគ្រីស្តាល់នៅទិសខាងលិច ដើម្បីចិញ្ចឹមធាតុ {dm_elem_kh} ឱ្យភ្លឺរលោងចែងចាំង។",
            "Water": f"រៀបចំចានទឹកហូរវិលជុំ ឬកែវទឹកស្អាតនៅទិសខាងជើងនៃគេហដ្ឋានដើម្បីបង្កើនលំហូរថាមពលធាតុ {dm_elem_kh} ឱ្យមានសន្ទុះខ្លាំងក្លា។"
        }
        remedy_tip = element_remedies.get(dm_elem, f"រៀបចំកន្លែងធ្វើការឱ្យមានពន្លឺ និងខ្យល់អាកាសបរិសុទ្ធដើម្បីពង្រឹងតុល្យភាពធាតុ {dm_elem_kh}។")

        # Clean directions for user-facing report to be 100% pure Khmer without Chinese annotations
        clean_dir = lambda s: re.sub(r'\s*\([^)]*[\u4e00-\u9fff/a-zA-Z]+[^)]*\)', '', s).replace(' / ', ' ឬ ').strip()
        wealth_dir_kh = clean_dir(dirs['wealth_god'])
        nobleman_dir_kh = clean_dir(dirs['nobleman_god'])
        joy_dir_kh = clean_dir(dirs['joy_god'])
        inauspicious_dir_kh = clean_dir(dirs['inauspicious_dir'])

        fengshui_tips = (
            f"១. រៀបចំតុធ្វើការឱ្យបែរមុខទៅរក {wealth_dir_kh} ឬ {nobleman_dir_kh} ដើម្បីស្រូបទាញលំហូរថាមពលវិជ្ជមាន និងការគាំពារពីមនុស្សខ្ពង់ខ្ពស់។\n"
            f"២. ប្រើប្រាស់សម្លៀកបំពាក់ ឬគ្រឿងអលង្ការដែលមាន {khmer['lucky_color']} ដើម្បីពង្រឹងបារមី និងបង្កើនមន្តស្នេហ៍ក្នុងការចរចា។\n"
            f"៣. {remedy_tip}\n"
            f"៤. ជៀសវាងការបង្កើតសំឡេងខ្លាំង ការដំដែកគោល ឬការជួសជុលនៅ {inauspicious_dir_kh} ដើម្បីការពារកុំឱ្យរំខានដល់ថាមពលអវិជ្ជមាននៃសាមសាហ៍ប្រចាំថ្ងៃ។"
        )
        ...
        body = (
            ...
            f"💰 ទិសទេវតាទ្រព្យ: {wealth_dir_kh} (ទិសដៅសម្រាប់រៀបចំតុធ្វើការ ពិភាក្សាជំនួញ និងប្រមូលលំហូរហិរញ្ញវត្ថុ)\n"
            f"👑 ទិសទេវតាមនុស្សខ្ពង់ខ្ពស់: {nobleman_dir_kh} (ទិសដៅសម្រាប់ស្វែងរកអ្នកជួយជ្រោមជ្រែង និងការពិគ្រោះយោបល់)\n"
            f"💖 ទិសទេវតាមង្គល: {joy_dir_kh} (ទិសដៅសម្រាប់បង្កើនមន្តស្នេហ៍ និងភាពចុះសម្រុងក្នុងគ្រួសារ)\n"
            f"🚫 ទិសដៅគួរប្រុងប្រយ័ត្ន: {inauspicious_dir_kh} (ជៀសវាងការជួសជុល ដំដែកគោល ឬការអង្គុយបែរមុខទៅរក)\n\n"
