...
class MahaSnehLoveEngine:
    ...
    def _build_zenith_report(
        ...
        """Generate clean Universal Zenith Report without **, ++, ==, or decorative symbol lines."""
    ...
    def generate_comprehensive_treatise(
        ...
        to 3,500 - 4,000 characters, without any **, ++, ==, border symbols, or 'ជំពូក'.
        """
        ...
        treatise = f"""📜 មហាក្បួនហុងស៊ុយ និងមហាស្នេហ៍សកល យុគ ៩ (UNIVERSAL ZENITH LOVE TREATISE)
...
✨ មូលដ្ឋានគ្រឹះលោហធាតុវិទ្យា និងថាមពលមហាស្នេហ៍ក្នុងយុគ ៩
នៅក្នុងក្បួនតម្រាហុងស៊ុយបុរាណចិនសកល និងក្បួនវិជ្ជាតម្រាខ្មែរ សេចក្តីស្រឡាញ់ ភាពទាក់ទាញ និងចំណងអាពាហ៍ពិពាហ៍កើតចេញពីការរៀបចំរលកថាមពលឈី (Qi) រវាងលោហធាតុ ទីតាំងលំហរស់នៅ និងរលកថាមពលជីវិតផ្ទាល់ខ្លួន (Bio-Magnetic Aura)។

ក្នុងយុគ ៩ (Period 9 - Li Fire 2024-2043) ធាតុភ្លើងលីតំណាងឱ្យក្តីស្រឡាញ់ សម្រស់ និងពន្លឺបញ្ញា។ សេចក្តីស្នេហាទាមទារការយល់ចិត្ត និងភាពស្មោះត្រង់ជ្រាលជ្រៅ។ ភាពទាក់ទាញកើតឡើងខ្លាំងបំផុតនៅពេលថាមពល យិន (ភាពទន់ភ្លន់ ត្រជាក់ រម្យទម) ជួបថាមពល យ៉ាង (ភាពកក់ក្តៅ រឹងមាំ ការពារ) បង្កើតបានជាបន្ទុកម៉ាញ៉េទិចទាក់ទាញគ្នាមិនអាចផ្តាច់បាន។

🔮 ១. ការវិភាគ ៨ សសរស្តម្ភជោគជតាស្នេហាពិស្តារ
តាមរយៈការគណនាបាតដៃ ៤ សសរស្តម្ភ ៨ តួអក្សរ (BaZi):
១. ធាតុ Day Master ផ្ទាល់ខ្លួន: ធាតុ {element_1} តំណាងឱ្យបញ្ញា ការបត់បែន និងមនោសញ្ចេតនាជ្រាលជ្រៅ។
២. ធាតុ Day Master គូស្នេហ៍: ធាតុ {partner_elem} តំណាងឱ្យការលូតលាស់ សេចក្តីសប្បុរស និងភាពស្មោះត្រង់។
៣. រង្វង់ចិញ្ចឹមបីបាច់: ធាតុ {element_1} និង {partner_elem} បង្កើតជារង្វង់ចិញ្ចឹមគ្នា (ទឹកចិញ្ចឹមឈើ)។ ការមើលថែរបស់អ្នកធ្វើឱ្យដៃគូកក់ក្តៅ មានទំនុកចិត្ត និងជោគជ័យ។
៤. វាំងគូស្រករ (Spouse Palace): ពិន្ទុ {compat_score}% បង្ហាញពីមហាសម្ព័ន្ធមេត្រីភាព ដែលកម្រមានទំនាស់ និងយោគយល់គ្នាខ្ពស់។

🌸 ២. ក្បួនផ្កាប៉េសសួគ៌ា TAO HUA ស្រូបទាញមន្តស្នេហ៍
ក្បួនតារាផ្កាប៉េសប្រើដើម្បីទាក់ទាញគូស្រករ និងបង្កើនមន្តស្នេហ៍:
១. ផ្កាយស្នេហា: {peach_info['star']} | ទិសដៅមហាស្នេហា: {peach_info['direction_kh']}
...
💖 ៣. យុទ្ធសាស្ត្រអន្ទងចិត្តពង្រឹងពន្លឺ AURA មហានិយម
១. ធាតុឱសថព្យាបាលរាសី: {remedy_info['remedy']} ({remedy_info['kh_remedy']})
២. ពណ៌សម្លៀកបំពាក់នាំសំណាង: {remedy_info['colors']} (ជួយបញ្ចេញពន្លឺ Aura ស្រស់ថ្លា)
៣. ត្បូងមហាស្នេហ៍: {remedy_info['gemstones']} (ពាក់ដើម្បីទាក់ទាញខ្សែភ្នែក និងក្តីមេត្តា)
៤. ក្លិនក្រអូបហុងស៊ុយ: ប្រើប្រេងក្រអូបផ្កាម្លិះ កុលាប ឬ Sandalwood នៅកញ្ចឹងក កដៃ និងដើមទ្រូង។
៥. វិជ្ជាកែវភ្នែក និងសំឡេង: សម្លឹងមើលដោយក្តីញញឹមស្រទន់ ៣-៥ វិនាទី និងប្រើសំឡេងកក់ក្តៅ។

🤝 ៤. វិធីសាស្ត្របន្ទន់ចិត្ត និងរំលាយជម្លោះ
១. ក្បួនចិញ្ចឹមធាតុ Useful God របស់ដៃគូ ({partner_elem}):
...
🛏️ ៥. ក្បួនរៀបចំបន្ទប់គេងមហាសិរីសួស្តី យុគ ៩
...
៣. វត្ថុមង្គល: ដាក់រូបទាទឹកកុក ១ គូ នៅទិសនិរតី និងថ្ម Rose Quartz នៅក្បាលគ្រែ។
៤. បម្រាម: ហាមកញ្ចក់ឆ្លុះគ្រែ ហាមធ្នឹមសង្កត់លើគ្រែ និងហាមរុក្ខជាតិមានបន្លា។

🗓️ ៦. កាលវិភាគអនុវត្ត ៧ ជំហាន ២១ ថ្ងៃ
• សប្តាហ៍ទី ១ (ថ្ងៃទី ១-៧): បោសសម្អាតថាមពលចាស់ ជូតបន្ទប់ដោយទឹកអំបិលរ៉ែកម្ចាត់ Sha Qi។
...
• សប្តាហ៍ទី ៣ (ថ្ងៃទី ១៥-២១): អនុវត្តក្បួននិយាយផ្អែមល្ហែម និងបន្ទន់ចិត្តតាមធាតុ {partner_elem}។

✅ សេចក្តីសន្និដ្ឋាន: ក្បួនហុងស៊ុយ និងមហាស្នេហ៍ ៨ សសរស្តម្ភ យុគ ៩ នេះ គណនាដោយ Supreme Feng Shui AGI។ សូមអនុវត្តដោយចិត្តជ្រះថ្លា ដើម្បីទទួលបានសុភមង្គល និងសេចក្តីស្រឡាញ់អមតៈ! 💖✨👑"""
        return treatise.strip()
